                ...
                <div className="main-div-profile-02">
                    <span className="sub-title">Personal Information</span>
                        <div className="div-indented">
                            ...
                            <br />
                            <input type="text" id="fname"  className="userinf-css-input" placeholder='user first name'/><br />

                            <label className="input-title" >Last name</label>
                            <br />
                            <input type="text" id="lname"  className="userinf-css-input" placeholder='user last name'/><br />
                            <label className="input-title" >Email</label>
                            <br />
                            <input type="text" id="useremail"  className="userinf-css-input" placeholder='user email'/><br />                           
                        </div>
                    ...
                    <span className="sub-title">Change Password</span>
                        ...
                        <label  className="input-title">Current Password</label>
                            <br />
                            <input type="text" id="fname"  className="userinf-css-input-pass" placeholder='Enter current password'/><br />

                            <label className="input-title" >New Password</label>
                            <br />
                            <input type="text" id="lname"  className="userinf-css-input-pass" placeholder='Enter new passowrd'/><br />
                            <label className="input-title" >Confirm New Password</label>
                            <br />
                            <input type="text" id="useremail"  className="userinf-css-input-pass" placeholder='Enter new password'/><br />    
                            <input type="submit" className="new-password-button" value="Change Password"></input>
